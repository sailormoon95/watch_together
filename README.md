...
LiveKit signaling слушает локально на `127.0.0.1:7880`, а media ports открываются напрямую: `7881/tcp`, `50000-50100/udp`, TURN/UDP `3478/udp` и relay range `50200-50300/udp`.
...
Для LiveKit нужно открыть на сервере `7881/tcp`, `3478/udp`, `50000-50100/udp` и `50200-50300/udp`, иначе камеры/микрофоны не смогут передавать media traffic в некоторых сетях.
